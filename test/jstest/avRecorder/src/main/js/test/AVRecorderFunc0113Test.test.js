...
describe('AVRecorderFuncTest', function () {
    ...
    async function prepareError(done) {
        console.info(`case to prepare error by promise`);
        await avRecorder.prepare(avConfig).then(() => {
            console.info('case recorder prepare by promise called');
    ...
    let avConfigBasic = {
        audioSourceType : media.AudioSourceType.AUDIO_SOURCE_TYPE_MIC,
        videoSourceType : media.VideoSourceType.VIDEO_SOURCE_TYPE_SURFACE_YUV,
        profile : avProfileBasic,
        url : 'fd://',
        rotation : 0,
        location : { latitude : 30, longitude : 130 }
    }

    async function createAVRecorder(done) {
        console.info(`case to create avRecorder by promise`);
        await media.createAVRecorder().then((recorder) => {
            console.info('case createAVRecorder promise called');
            if (typeof (recorder) != 'undefined') {
    ...
    async function getInputSurface() {
        console.info(`case to getsurface by promise`);
        await avRecorder.getInputSurface().then((outputSurface) => {
            console.info('case getInputSurface by promise called');
            surfaceID = outputSurface;
    ...
    async function releaseAVRecorder() {
        console.info(`case to getsurface by promise`);
        await avRecorder.release().then(() => {
            console.info('case recorder release by promise called');
        }, mediaTestBase.failureCallback).catch(mediaTestBase.catchCallback);
    ...
    // /* *
    // * @tc.number    : Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_0100
    ...
    //     let fileName = 'AVRecorder_PrepareWrong_0'+ caseCount +'.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    //     console.info("case fdPath is: " + fdPath);

    //     await createAVRecorder();
    ...
    //     }
    //     avConfig.url = fdPath;
    //     await prepareError(done);
    //     await getInputSurface();
    //     await startVideoOutput();
    //     await startByPromise();
    //     await mediaTestBase.msleepAsync(2000);
    //     await resetByPromise();
    ...
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_0200', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_0'+ caseCount +'.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    //     console.info("case fdPath is: " + fdPath);
    //     await createAVRecorder();
    //     console.info('case prepare error 2');
    //     avProfile = {
    //         audioBitrate : 100000,
    //         audioCodec : media.CodecMimeType.AUDIO_AAC,
    //         audioSampleRate : 44100,
    ...
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_0300', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_0'+ caseCount +'.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    ...
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_0400', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_0'+ caseCount +'.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    ...
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_0500', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_0'+ caseCount +'.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    ...
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_0600', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_0'+ caseCount +'.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    ...
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_0700', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_0'+ caseCount +'.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    ...
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_0800', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_0'+ caseCount +'.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    ...
    // // case failureCallback called,errMessage is The operate GetInputSurface failed due to not permit in current state.The VideoSourceType is not configured. Please do not call getInputSurface
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_0900', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_0'+ caseCount +'.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    ...
    // // case failureCallback called,errMessage is The Parameter videoFrameWidth is invalid. Please check the type and range.
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_1000', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_0'+ caseCount +'.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    ...
    // // case failureCallback called,errMessage is The Parameter videoFrameWidth is invalid. Please check the type and range.
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_1100', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_0'+ caseCount +'.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    ...
    // // case failureCallback called,errMessage is The Parameter audioChannels is invalid. Please check the type and range
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_1200', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_0'+ caseCount +'.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    ...
    // 规格不支持未报错无异常
    it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_Audio_Vorbis', 0, async function (done) {
        let fileName = 'AVRecorder_PrepareWrong_Audio_Vorbis.mp4';
        console.info("case current fileName is: " + fileName);
        fdObject = await mediaTestBase.getFd(fileName, 'video');
        fdPath = "fd://" + fdObject.fdNumber.toString();
        console.info("case fdPath is: " + fdPath);
        ...
        avProfile = {
            audioBitrate : 100000,
            audioChannels : 1,
            audioCodec : media.CodecMimeType.AUDIO_VORBIS,
            audioSampleRate : 44100,
            fileFormat : media.ContainerFormatType.CFT_MPEG_4,
            videoBitrate : 20000,
            videoCodec : media.CodecMimeType.VIDEO_AVC,
    ...
    it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_Video_VP8', 0, async function (done) {
        let fileName = 'AVRecorder_PrepareWrong_Video_vp8.mp4';
        console.info("case current fileName is: " + fileName);
        fdObject = await mediaTestBase.getFd(fileName, 'video');
        fdPath = "fd://" + fdObject.fdNumber.toString();
        console.info("case fdPath is: " + fdPath);
        ...
        avProfile = {
            ...
            fileFormat : media.ContainerFormatType.CFT_MPEG_4,
            videoBitrate : 20000000,
            videoCodec : media.CodecMimeType.VIDEO_VP8,
            videoFrameWidth : 640,
            videoFrameHeight : 480,
            videoFrameRate : 45
        }
    ...
    // // case failureCallback called,errMessage is The Parameter videoFrameRate is invalid. Please check the type and range.
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_1500', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_0'+ caseCount +'.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    ...
    // 视频帧率设置超大，未报错录制文件异常
    it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_Framerate_10000', 0, async function (done) {
        let fileName = 'AVRecorder_PrepareWrong_Framerate_10000.mp4';
        console.info("case current fileName is: " + fileName);
        fdObject = await mediaTestBase.getFd(fileName, 'video');
        fdPath = "fd://" + fdObject.fdNumber.toString();
        console.info("case fdPath is: " + fdPath);
    ...
    // // 无报错
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_1700', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_0'+ caseCount +'.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    ...
    it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_Rotation_100', 0, async function (done) {
        let fileName = 'AVRecorder_PrepareWrong_Rotation_100.mp4';
        console.info("case current fileName is: " + fileName);
        fdObject = await mediaTestBase.getFd(fileName, 'video');
        fdPath = "fd://" + fdObject.fdNumber.toString();
        console.info("case fdPath is: " + fdPath);
    ...
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_1900', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_0'+ caseCount +'.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    ...
    it('Sub_Multimedia_Media_AVRecorder_Prepare_VideoSourceType', 0, async function (done) {
        let fileName = 'AVRecorder_PrepareWrong_VideoSourceType.mp4';
        console.info("case current fileName is: " + fileName);
        fdObject = await mediaTestBase.getFd(fileName, 'video');
        fdPath = "fd://" + fdObject.fdNumber.toString();
        console.info("case fdPath is: " + fdPath);
    ...
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_AudioSourceType', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_AudioSourceType.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    //     console.info("case fdPath is: " + fdPath);
    ...
    it('Sub_Multimedia_Media_AVRecorder_Prepare_AudioSourceType2', 0, async function (done) {
        let fileName = 'AVRecorder_PrepareWrong_AudioSourceType2.mp4';
        console.info("case current fileName is: " + fileName);
        fdObject = await mediaTestBase.getFd(fileName, 'video');
        fdPath = "fd://" + fdObject.fdNumber.toString();
        console.info("case fdPath is: " + fdPath);
