...
describe('AVRecorderFuncTest', function () {
    ...
    async function releaseCamera() {
        console.info('[camera] case main to release cameraInput');
        await cameraInput.release().then(() => {
            console.info('[camera] case main cameraInput release called');
        }, mediaTestBase.failureCallback).catch(mediaTestBase.catchCallback);
        console.info('[camera] case cameraInput release success');
    ...
    */
    it('Sub_Multimedia_Media_AVRecorder_Func_0200', 0, async function (done) {
        ...
        mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK, PAUSE_CALLBACK,
            RESUME_CALLBACK, STOP_CALLBACK, STOPVIDEOOUTPUT, RESET_CALLBACK, SETCALLBACKOFF, RELEASE_CALLBACK, RELEASECAMERA, END);
        nextStep(done);
    })
    ...
    */
    it('Sub_Multimedia_Media_AVRecorder_Func_0300', 0, async function (done) {
        ...
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE, PAUSE_PROMISE,
            RESUME_PROMISE, PAUSE_PROMISE, RESET_PROMISE, STOPVIDEOOUTPUT, SETCALLBACKOFF, RELEASE_PROMISE, RELEASECAMERA, END);
        nextStep(done);
    })
    ...
    */
    it('Sub_Multimedia_Media_AVRecorder_Func_0500', 0, async function (done) {
        ...
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE, RESET_PROMISE,
            STOPVIDEOOUTPUT, SETCALLBACKOFF, RELEASE_PROMISE, RELEASECAMERA, END);
        nextStep(done);
    })
    ...
    */
    it('Sub_Multimedia_Media_AVRecorder_Func_0600', 0, async function (done) {
        ...
        mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK, RESET_CALLBACK,
            STOPVIDEOOUTPUT, SETCALLBACKOFF, RELEASE_CALLBACK, RELEASECAMERA, END);
        nextStep(done);
    })
    ...
    */
    it('Sub_Multimedia_Media_AVRecorder_Func_0700', 0, async function (done) {
        ...
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
            RELEASE_PROMISE, STOPVIDEOOUTPUT, RELEASECAMERA, END);
        nextStep(done);
    })
    ...
    */
    it('Sub_Multimedia_Media_AVRecorder_Func_0800', 0, async function (done) {
        ...
        mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK,
            RELEASE_CALLBACK, STOPVIDEOOUTPUT, RELEASECAMERA, END);
        nextStep(done);
    })
    ...
    */
    it('Sub_Multimedia_Media_AVRecorder_Func_1100', 0, async function (done) {
        ...
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE, PAUSE_PROMISE, 
            STOP_PROMISE, STOPVIDEOOUTPUT, RELEASE_PROMISE, RELEASECAMERA, END);
        nextStep(done);
    })
    ...
    */
    it('Sub_Multimedia_Media_AVRecorder_Func_1200', 0, async function (done) {
        ...
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK, PAUSE_CALLBACK,
            STOP_CALLBACK, STOPVIDEOOUTPUT, RELEASE_CALLBACK, RELEASECAMERA, END);
        nextStep(done);
    })
    ...
    */
    it('Sub_Multimedia_Media_AVRecorder_Func_1300', 0, async function (done) {
        ...
        mySteps = new Array(CREATE_PROMISE, PREPARE_CALLBACK, GETSURFACE_PROMISE, STARTCAMERA, START_CALLBACK, PAUSE_PROMISE,
            RESUME_CALLBACK, STOP_PROMISE, STOPVIDEOOUTPUT, RESET_CALLBACK, SETCALLBACKOFF, RELEASE_PROMISE, RELEASECAMERA, END);
        nextStep(done);
    })
    ...
    */
    it('Sub_Multimedia_Media_AVRecorder_Func_1400', 0, async function (done) {
        ...
        mySteps = new Array(CREATE_CALLBACK, PREPARE_PROMISE, GETSURFACE_CALLBACK, STARTCAMERA, START_PROMISE, PAUSE_CALLBACK,
            RESUME_PROMISE, STOP_CALLBACK, STOPVIDEOOUTPUT, RESET_PROMISE, SETCALLBACKOFF, RELEASE_CALLBACK, RELEASECAMERA, END);
        nextStep(done);
    })
    ...
    */
    it('Sub_Multimedia_Media_AVRecorder_Func_1500', 0, async function (done) {
        ...
        mySteps = new Array(CREATE_CALLBACK, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_CALLBACK, PAUSE_CALLBACK,
            RESUME_PROMISE, STOP_CALLBACK, STOPVIDEOOUTPUT, RESET_PROMISE, RELEASE_CALLBACK, RELEASECAMERA, END);
        nextStep(done);
    })
    ...
    */
    it('Sub_Multimedia_Media_AVRecorder_Func_1600', 0, async function (done) {
        ...
        mySteps = new Array(CREATE_PROMISE, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_PROMISE, PAUSE_PROMISE,
            RESUME_CALLBACK, STOP_CALLBACK, STOPVIDEOOUTPUT, RESET_CALLBACK, RELEASE_PROMISE, RELEASECAMERA, END);
        nextStep(done);
    })
    ...
    * @tc.name      : 01. test avRecorder reset interface
    * @tc.desc      : test avRecorder prepare-reset
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Reset_Promise_0100', 0, async function (done) {
        let fileName = 'avRecorder_reset_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, RESET_PROMISE, RELEASE_PROMISE, END);
        nextStep(done);
    })

    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_Reset_Promise_0200
    * @tc.name      : 01. test avRecorder reset interface
    * @tc.desc      : test avRecorder getInputSurface-reset
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Reset_Promise_0200', 0, async function (done) {
        let fileName = 'avRecorder_reset_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, RESET_PROMISE, RELEASE_PROMISE, END);
        nextStep(done);
    })

    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_Reset_Promise_0300
    * @tc.name      : 01. test avRecorder reset interface
    * @tc.desc      : test avRecorder start-reset
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Reset_Promise_0300', 0, async function (done) {
        let fileName = 'avRecorder_reset_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
    ...
    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_Reset_Promise_0400
    * @tc.name      : 01. test avRecorder reset interface
    * @tc.desc      : test avRecorder pause-reset
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Reset_Promise_0400', 0, async function (done) {
        let fileName = 'avRecorder_reset_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
            PAUSE_PROMISE, RESET_PROMISE, STOPVIDEOOUTPUT, RELEASE_PROMISE, RELEASECAMERA, END);
        nextStep(done);
    })

    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_Reset_Promise_0500
    * @tc.name      : 01. test avRecorder reset interface
    * @tc.desc      : test avRecorder resume-reset
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Reset_Promise_0500', 0, async function (done) {
        let fileName = 'avRecorder_reset_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
            PAUSE_PROMISE, RESUME_PROMISE, RESET_PROMISE, STOPVIDEOOUTPUT, RELEASE_PROMISE, RELEASECAMERA, END);
        nextStep(done);
    })

    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_Reset_Promise_0600
    * @tc.name      : 01. test avRecorder reset interface
    * @tc.desc      : test avRecorder stop-reset
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Reset_Promise_0600', 0, async function (done) {
        let fileName = 'avRecorder_reset_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
            PAUSE_PROMISE, RESUME_PROMISE, STOP_PROMISE, RESET_PROMISE, STOPVIDEOOUTPUT, RELEASE_PROMISE, RELEASECAMERA, END);
        nextStep(done);
    })
    ...
    // // /* *
    // // * @tc.number    : Sub_Multimedia_Media_AVRecorder_Reset_Callback_0300
    // // * @tc.name      : 01. test avRecorder reset interface
    // // * @tc.desc      : test avRecorder prepare-reset
    // // * @tc.size      : MediumTest
    // // * @tc.type      : Function
    // // * @tc.level     : Level0
    // // */
    // // it('Sub_Multimedia_Media_AVRecorder_Reset_Callback_0300', 0, async function (done) {
    // //     let fileName = 'avRecorder_reset_0'+ caseCount +'.mp4';
    // //     await getRecorderFileFd(fileName, 'video');
    // //     mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, RESET_CALLBACK, RELEASE_CALLBACK, END);
    // //     nextStep(done);
    // // })

    // // /* *
    // // * @tc.number    : Sub_Multimedia_Media_AVRecorder_Reset_Callback_0400
    // // * @tc.name      : 01. test avRecorder reset interface
    // // * @tc.desc      : test avRecorder getInputSurface-reset
    // // * @tc.size      : MediumTest
    // // * @tc.type      : Function
    // // * @tc.level     : Level0
    // // */
    // // it('Sub_Multimedia_Media_AVRecorder_Reset_Callback_0400', 0, async function (done) {
    // //     let fileName = 'avRecorder_reset_0'+ caseCount +'.mp4';
    // //     await getRecorderFileFd(fileName, 'video');
    // //     mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, RESET_CALLBACK, RELEASE_CALLBACK, END);
    // //     nextStep(done);
    // // })

    // // /* *
    // // * @tc.number    : Sub_Multimedia_Media_AVRecorder_Reset_Callback_0500
    // // * @tc.name      : 01. test avRecorder reset interface
    // // * @tc.desc      : test avRecorder start-reset
    // // * @tc.size      : MediumTest
    // // * @tc.type      : Function
    // // * @tc.level     : Level0
    // // */
    // // it('Sub_Multimedia_Media_AVRecorder_Reset_Callback_0500', 0, async function (done) {
    // //     let fileName = 'avRecorder_reset_0'+ caseCount +'.mp4';
    // //     await getRecorderFileFd(fileName, 'video');
    // //     mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK,
    // //         RESET_CALLBACK, STOPVIDEOOUTPUT, RELEASE_CALLBACK, END);
    // //     nextStep(done);
    // // })

    // // /* *
    // // * @tc.number    : Sub_Multimedia_Media_AVRecorder_Reset_Callback_0600
    // // * @tc.name      : 01. test avRecorder reset interface
    // // * @tc.desc      : test avRecorder pause-reset
    // // * @tc.size      : MediumTest
    // // * @tc.type      : Function
    // // * @tc.level     : Level0
    // // */
    // // it('Sub_Multimedia_Media_AVRecorder_Reset_Callback_0600', 0, async function (done) {
    // //     let fileName = 'avRecorder_reset_0'+ caseCount +'.mp4';
    // //     await getRecorderFileFd(fileName, 'video');
    // //     mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK,
    // //         PAUSE_CALLBACK, RESET_CALLBACK, STOPVIDEOOUTPUT, RELEASE_CALLBACK, END);
    // //     nextStep(done);
    // // })

    // // /* *
    // // * @tc.number    : Sub_Multimedia_Media_AVRecorder_Reset_Callback_0700
    // // * @tc.name      : 01. test avRecorder reset interface
    // // * @tc.desc      : test avRecorder resume-reset
    // // * @tc.size      : MediumTest
    // // * @tc.type      : Function
    // // * @tc.level     : Level0
    // // */
    // // it('Sub_Multimedia_Media_AVRecorder_Reset_Callback_0700', 0, async function (done) {
    // //     let fileName = 'avRecorder_reset_0'+ caseCount +'.mp4';
    // //     await getRecorderFileFd(fileName, 'video');
    // //     mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK,
    // //         PAUSE_CALLBACK, RESUME_CALLBACK, RESET_CALLBACK, STOPVIDEOOUTPUT, RELEASE_CALLBACK, END);
    // //     nextStep(done);
    // // })

    // // /* *
    // // * @tc.number    : Sub_Multimedia_Media_AVRecorder_Reset_Callback_0800
    // // * @tc.name      : 01. test avRecorder reset interface
    // // * @tc.desc      : test avRecorder stop-reset
    // // * @tc.size      : MediumTest
    // // * @tc.type      : Function
    // // * @tc.level     : Level0
    // // */
    // // it('Sub_Multimedia_Media_AVRecorder_Reset_Callback_0800', 0, async function (done) {
    // //     let fileName = 'avRecorder_reset_0'+ caseCount +'.mp4';
    // //     await getRecorderFileFd(fileName, 'video');
    // //     mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK,
    // //         PAUSE_CALLBACK, RESUME_CALLBACK, STOP_CALLBACK, RESET_CALLBACK, STOPVIDEOOUTPUT, RELEASE_CALLBACK, END);
    // //     nextStep(done);
    // // })
    ...
    * @tc.name      : 01. test avRecorder release interface
    * @tc.desc      : test avRecorder xxx-release
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Release_Promise_0100', 0, async function (done) {
        let fileName = 'avRecorder_release_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, RELEASE_PROMISE, END);
        nextStep(done);
    })

    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_Release_Promise_0200
    * @tc.name      : 01. test avRecorder release interface
    * @tc.desc      : test avRecorder xxx-release
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Release_Promise_0200', 0, async function (done) {
        let fileName = 'avRecorder_release_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, RELEASE_PROMISE, END);
        nextStep(done);
    })

    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_Release_Promise_0300
    * @tc.name      : 01. test avRecorder release interface
    * @tc.desc      : test avRecorder xxx-release
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Release_Promise_0300', 0, async function (done) {
        let fileName = 'avRecorder_release_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, RELEASE_PROMISE, END);
        nextStep(done);
    ...
    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_Release_Promise_0400
    * @tc.name      : 01. test avRecorder release interface
    * @tc.desc      : test avRecorder xxx-release
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Release_Promise_0400', 0, async function (done) {
        let fileName = 'avRecorder_release_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
            STOPVIDEOOUTPUT, RELEASE_PROMISE, RELEASECAMERA, END);
        nextStep(done);
    })

    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_Release_Promise_0500
    * @tc.name      : 01. test avRecorder release interface
    * @tc.desc      : test avRecorder xxx-release
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Release_Promise_0500', 0, async function (done) {
        let fileName = 'avRecorder_release_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
            PAUSE_PROMISE, RELEASE_PROMISE, STOPVIDEOOUTPUT, RELEASECAMERA, END);
        nextStep(done);
    })

    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_Release_Promise_0600
    * @tc.name      : 01. test avRecorder release interface
    * @tc.desc      : test avRecorder xxx-release
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Release_Promise_0600', 0, async function (done) {
        let fileName = 'avRecorder_release_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
            PAUSE_PROMISE, RESUME_PROMISE, STOPVIDEOOUTPUT, RELEASE_PROMISE, RELEASECAMERA, END);
        nextStep(done);
    })

    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_Release_Promise_0700
    * @tc.name      : 01. test avRecorder release interface
    * @tc.desc      : test avRecorder xxx-release
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Release_Promise_0700', 0, async function (done) {
        let fileName = 'avRecorder_release_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
            PAUSE_PROMISE, RESUME_PROMISE, STOP_PROMISE, STOPVIDEOOUTPUT, RELEASE_PROMISE, RELEASECAMERA, END);
        nextStep(done);
    })

    // /* *
    // * @tc.number    : Sub_Multimedia_Media_AVRecorder_Release_Callback_0100
    // * @tc.name      : 01. test avRecorder release interface
    // * @tc.desc      : test avRecorder xxx-release
    // * @tc.size      : MediumTest
    // * @tc.type      : Function
    // * @tc.level     : Level0
    // */
    // it('Sub_Multimedia_Media_AVRecorder_Release_Callback_0100', 0, async function (done) {
    //     let fileName = 'avRecorder_release_0'+ caseCount +'.mp4';
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_CALLBACK, RELEASE_CALLBACK, END);
    //     nextStep(done);
    // })

    // /* *
    // * @tc.number    : Sub_Multimedia_Media_AVRecorder_Release_Callback_0200
    // * @tc.name      : 01. test avRecorder release interface
    // * @tc.desc      : test avRecorder xxx-release
    // * @tc.size      : MediumTest
    // * @tc.type      : Function
    // * @tc.level     : Level0
    // */
    // it('Sub_Multimedia_Media_AVRecorder_Release_Callback_0200', 0, async function (done) {
    //     let fileName = 'avRecorder_release_0'+ caseCount +'.mp4';
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, RELEASE_CALLBACK, END);
    //     nextStep(done);
    // })

    // /* *
    // * @tc.number    : Sub_Multimedia_Media_AVRecorder_Release_Callback_0300
    // * @tc.name      : 01. test avRecorder release interface
    // * @tc.desc      : test avRecorder xxx-release
    // * @tc.size      : MediumTest
    // * @tc.type      : Function
    // * @tc.level     : Level0
    // */
    // it('Sub_Multimedia_Media_AVRecorder_Release_Callback_0300', 0, async function (done) {
    //     let fileName = 'avRecorder_release_0'+ caseCount +'.mp4';
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, RELEASE_CALLBACK, END);
    //     nextStep(done);
    ...
    // /* *
    // * @tc.number    : Sub_Multimedia_Media_AVRecorder_Release_Callback_0400
    // * @tc.name      : 01. test avRecorder release interface
    // * @tc.desc      : test avRecorder xxx-release
    // * @tc.size      : MediumTest
    // * @tc.type      : Function
    // * @tc.level     : Level0
    // */
    // it('Sub_Multimedia_Media_AVRecorder_Release_Callback_0400', 0, async function (done) {
    //     let fileName = 'avRecorder_release_0'+ caseCount +'.mp4';
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK,
    //         STOPVIDEOOUTPUT, RELEASE_CALLBACK, RELEASECAMERA, END);
    //     nextStep(done);
    // })

    // /* *
    // * @tc.number    : Sub_Multimedia_Media_AVRecorder_Release_Callback_0500
    // * @tc.name      : 01. test avRecorder release interface
    // * @tc.desc      : test avRecorder xxx-release
    // * @tc.size      : MediumTest
    // * @tc.type      : Function
    // * @tc.level     : Level0
    // */
    // it('Sub_Multimedia_Media_AVRecorder_Release_Callback_0500', 0, async function (done) {
    //     let fileName = 'avRecorder_release_0'+ caseCount +'.mp4';
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK,
    //         PAUSE_CALLBACK, STOPVIDEOOUTPUT, RELEASE_CALLBACK, RELEASECAMERA, END);
    //     nextStep(done);
    // })

    // /* *
    // * @tc.number    : Sub_Multimedia_Media_AVRecorder_Release_Callback_0600
    // * @tc.name      : 01. test avRecorder release interface
    // * @tc.desc      : test avRecorder xxx-release
    // * @tc.size      : MediumTest
    // * @tc.type      : Function
    // * @tc.level     : Level0
    // */
    // it('Sub_Multimedia_Media_AVRecorder_Release_Callback_0600', 0, async function (done) {
    //     let fileName = 'avRecorder_release_0'+ caseCount +'.mp4';
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK,
    //         PAUSE_CALLBACK, RESUME_CALLBACK, STOPVIDEOOUTPUT, RELEASE_CALLBACK, RELEASECAMERA, END);
    //     nextStep(done);
    // })

    // /* *
    // * @tc.number    : Sub_Multimedia_Media_AVRecorder_Release_Callback_0700
    // * @tc.name      : 01. test avRecorder release interface
    // * @tc.desc      : test avRecorder xxx-release
    // * @tc.size      : MediumTest
    // * @tc.type      : Function
    // * @tc.level     : Level0
    // */
    // it('Sub_Multimedia_Media_AVRecorder_Release_Callback_0700', 0, async function (done) {
    //     let fileName = 'avRecorder_release_0'+ caseCount +'.mp4';
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK,
    //         PAUSE_CALLBACK, RESUME_CALLBACK, STOP_CALLBACK, STOPVIDEOOUTPUT, RELEASE_CALLBACK, RELEASECAMERA, END);
    //     nextStep(done);
    // })


    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_Prepare_Promise_0100
    * @tc.name      : 01. test avRecorder prepare interface
    * @tc.desc      : test avRecorder prepare-xxx-reset-prepare-xxx-END
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Prepare_Promise_0100', 0, async function (done) {
        let fileName = 'avRecorder_prepare_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE, 
            STOPVIDEOOUTPUT, RESET_PROMISE, RELEASECAMERA, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE, 
            STOPVIDEOOUTPUT, RESET_PROMISE, RELEASE_PROMISE, RELEASECAMERA, END);
        nextStep(done);
    })

    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_Prepare_Promise_0200
    * @tc.name      : 01. test avRecorder prepare interface
    * @tc.desc      : test avRecorder prepare-xxx-stop-prepare-xxx-END
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Prepare_Promise_0200', 0, async function (done) {
        let fileName = 'avRecorder_prepare_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE, 
    ...
    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_Prepare_Callback_0100
    * @tc.name      : 01. test avRecorder prepare interface
    * @tc.desc      : test avRecorder prepare-xxx-reset-prepare-xxx-END
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Prepare_Callback_0100', 0, async function (done) {
        let fileName = 'avRecorder_prepare_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK, 
            STOPVIDEOOUTPUT, RESET_CALLBACK, RELEASECAMERA, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK, 
            STOPVIDEOOUTPUT, RESET_CALLBACK, RELEASE_CALLBACK, RELEASECAMERA, END);
        nextStep(done);
    })

    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_Prepare_Callback_0200
    * @tc.name      : 01. test avRecorder prepare interface
    * @tc.desc      : test avRecorder prepare-xxx-stop-prepare-xxx-END
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Prepare_Callback_0200', 0, async function (done) {
        let fileName = 'avRecorder_prepare_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK, 
    ...
    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_WrongConfig_0100
    ...
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_WrongConfig_0100', 0, async function (done) {
    ...
    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_WrongConfig_0200
    * @tc.name      : 01. test avRecorder prepare configs
    ...
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_WrongConfig_0200', 0, async function (done) {
    ...
    */
    it('Sub_Multimedia_Media_AudioRecorder_Func_0100', 0, async function (done) {
        ...
        caseCount = 1;
        let fileName = 'audioRecorder_func_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, START_PROMISE, PAUSE_PROMISE, 
            RESUME_PROMISE, STOP_PROMISE, RESET_PROMISE, SETCALLBACKOFF, RELEASE_PROMISE, END);
        nextStep(done);
    })
    ...
    */
    it('Sub_Multimedia_Media_AudioRecorder_Func_0200', 0, async function (done) {
        ...
        mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, START_CALLBACK, PAUSE_CALLBACK,
            RESUME_CALLBACK, STOP_CALLBACK, RESET_CALLBACK, SETCALLBACKOFF, RELEASE_CALLBACK, END);
        nextStep(done);
    })
    ...
    */
    ...
    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_ReCall_0100
    * @tc.name      : 01. test avRecorder basic function by promise interfaces
    * @tc.desc      : test avRecorder operation: create-create
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_ReCall_0100', 0, async function (done) {
        let fileName = 'avRecorder_reRelease_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        console.info('case to createAVRecorder promise 1');
        await media.createAVRecorder().then((recorder) => {
            console.info('case createAVRecorder promise called');
            if (typeof (recorder) != 'undefined') {
                avRecorder = recorder;
        ...
        console.info('case to reset promise 1');
        await resetByPromise();

        console.info('case to prepare promise 1');
        await prepareByPromise();
        console.info('case to prepare promise 2');
        await avRecorder.prepare(avConfig).then(() => {
            console.info('case recorder prepare by promise 2 called');
        }, printFailure).catch(printCatchError);

        console.info('case to getSurfaceInput promise 1');
        await avRecorder.getInputSurface().then((outputSurface) => {
            console.info('case getInputSurface by promise called');
            surfaceID = outputSurface;
            console.info('case outputSurface surfaceID is: ' + surfaceID);
        }, mediaTestBase.failureCallback).catch(mediaTestBase.catchCallback);
        console.info('case to getSurfaceInput promise 2');
        await avRecorder.getInputSurface().then((outputSurface) => {
            console.info('case getInputSurface by promise called');
            surfaceID = outputSurface;
            console.info('case outputSurface surfaceID is: ' + surfaceID);
        ...
        await startVideoOutput();
        console.info('case to start promise 1');
        await startByPromise();
        console.info('case to start promise 2');
        await startByPromise();
        console.info('case to resume promise 1');
        await resumeByPromise();
        console.info('case to resume promise 2');
        await resumeByPromise();

        console.info('case to pause promise 1');
        await pauseByPromise();
        console.info('case to pause promise 1');
        await pauseByPromise();

        console.info('case to resume promise 3');
        await resumeByPromise();
        console.info('case to resume promise 4');
        await resumeByPromise();
        console.info('case to start promise 3');
        await startByPromise();
        console.info('case to start promise 4');
        await startByPromise();

        console.info('case to stop promise 1');
        await stopByPromise();
        console.info('case to stop promise 2');
        await stopByPromise();

        console.info('case to reset promise 1');
        await resetByPromise();
        console.info('case to reset promise 2');
        await resetByPromise();

        console.info('case to release createAVRecorder promise 1');
        await releaseByPromise();
        console.info('case to release createAVRecorder promise 2');
        await releaseByPromise();
    ...
    // * @tc.level     : Level0
    // */
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Wrong_0100', 0, async function (done) {
    //     let avProfileBasic = {
    //         audioBitrate : 48000,
    //         audioChannels : 2,
    //         audioCodec : media.CodecMimeType.AUDIO_AAC,
    ...
    //     avConfig = avConfigBasic;
    //     delete avConfig.profile.audioBitrate;
    //     console.info('case avConfig.profile[0] is ' + avConfig.profile[0]);
    //     // caseCount = 1;
    //     // let fileName = 'audioRecorder_func_0'+ caseCount +'.mp4';
    //     // await getRecorderFileFd(fileName, 'video');
    //     // mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, START_PROMISE, PAUSE_PROMISE, 
