...
describe('AVRecorderFuncTest', function () {
    ...
    // * @tc.desc      : test avRecorder xxx-reset
    // * @tc.size      : MediumTest
    // * @tc.type      : Function
    // * @tc.level     : Level0
    // */
    ...
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
    //         RESET_PROMISE, STOPVIDEOOUTPUT, RELEASE_PROMISE, END);
    //     nextStep(done);
    // })
    ...
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
    //         PAUSE_PROMISE, RESET_PROMISE, STOPVIDEOOUTPUT, RELEASE_PROMISE, END);
    //     nextStep(done);
    // })
    ...
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
    //         PAUSE_PROMISE, RESUME_PROMISE, RESET_PROMISE, STOPVIDEOOUTPUT, RELEASE_PROMISE, END);
    //     nextStep(done);
    // })
    ...
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
    //         PAUSE_PROMISE, RESUME_PROMISE, STOP_PROMISE, RESET_PROMISE, STOPVIDEOOUTPUT, RELEASE_PROMISE, END);
    //     nextStep(done);
    // })
    ...
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK,
    //         STOPVIDEOOUTPUT, RELEASE_CALLBACK, END);
    //     nextStep(done);
    // })
    ...
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK,
    //         PAUSE_CALLBACK, STOPVIDEOOUTPUT, RELEASE_CALLBACK, END);
    //     nextStep(done);
    // })
    ...
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK,
    //         PAUSE_CALLBACK, RESUME_CALLBACK, STOPVIDEOOUTPUT, RELEASE_CALLBACK, END);
    //     nextStep(done);
    // })
    ...
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START_CALLBACK,
    //         PAUSE_CALLBACK, RESUME_CALLBACK, STOP_CALLBACK, STOPVIDEOOUTPUT, RELEASE_CALLBACK, END);
    //     nextStep(done);
    // })
    ...
    // * @tc.desc      : test avRecorder prepare-reset-prepare-xxx-END
    // * @tc.size      : MediumTest
    // * @tc.type      : Function
    // * @tc.level     : Level0
    // */
    ...
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, RESET_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK,
    //         STARTCAMERA, START_CALLBACK, STOPVIDEOOUTPUT, RESET_CALLBACK, RELEASE_CALLBACK, END);
    //     nextStep(done);
    // })
    ...
    */
    it('Sub_Multimedia_Media_AVRecorder_Prepare_Promise_0100', 0, async function (done) {
        let fileName = 'avRecorder_prepare_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, RESET_PROMISE, PREPARE_PROMISE, 
            GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE, STOPVIDEOOUTPUT, RESET_PROMISE, RELEASE_PROMISE, END);
        nextStep(done);
    })
    ...
    it('Sub_Multimedia_Media_AVRecorder_Prepare_Promise_0200', 0, async function (done) {
        ...
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE, 
            STOPVIDEOOUTPUT, RESET_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE, 
            STOPVIDEOOUTPUT, RESET_PROMISE, RELEASE_PROMISE, END);
        nextStep(done);
    })
    ...
    * @tc.name      : 01. test avRecorder prepare interface
    * @tc.desc      : test avRecorder prepare-stop-prepare-xxx-END
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Prepare_Promise_0300', 0, async function (done) {
        let fileName = 'avRecorder_prepare_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE, 
            STOP_PROMISE, STOPVIDEOOUTPUT, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE, 
            RESET_PROMISE, STOPVIDEOOUTPUT, RELEASE_PROMISE, END);
        nextStep(done);
    })
    ...
    // /* *
    // * @tc.number    : Sub_Multimedia_Media_AudioRecorder_Prepare_Promise_0200
    // * @tc.name      : 01. test avRecorder prepare interface
    // * @tc.desc      : test avRecorder prepare-stop-prepare-xxx-END
    // * @tc.size      : MediumTest
    // * @tc.type      : Function
    // * @tc.level     : Level0
    // */
    // it('Sub_Multimedia_Media_AudioRecorder_Prepare_Promise_0200', 0, async function (done) {
    //     avConfig = audioConfig;
    //     let fileName = 'audioRecorder_prepare_0'+ caseCount +'.m4a';
    //     await getRecorderFileFd(fileName, 'audio');
    //     mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, START_PROMISE, STOP_PROMISE, PREPARE_PROMISE, START_PROMISE, 
    //         RESET_PROMISE, RELEASE_PROMISE, END);
    //     nextStep(done);
    // })
    ...
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, RESET_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK,
    //         STARTCAMERA, START_CALLBACK, STOPVIDEOOUTPUT, STOP_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK,
    //         STARTCAMERA, START_CALLBACK, STOPVIDEOOUTPUT, RESET_CALLBACK, RELEASE_CALLBACK, END);
    //     nextStep(done);
    // })
