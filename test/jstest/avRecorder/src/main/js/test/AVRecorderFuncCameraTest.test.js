...
describe('AVRecorderFuncTest', function () {
    ...
    async function stopVideoOutput() {
        ...
        if (videoOutput) {
            ...
            await captureSession.removeOutput(videoOutput).then(() => {
                console.info('case camera remove videoOutput');
            }, mediaTestBase.failureCallback).catch(mediaTestBase.catchCallback);
            console.info('case remove videoOutput done');
        }
        // if (previewOutput) {
        //     console.info('case camera to remove previewOutput');
        //     await captureSession.removeOutput(previewOutput).then(() => {
        //         console.info('case camera remove previewOutput');
        //     }, mediaTestBase.failureCallback).catch(mediaTestBase.catchCallback);
        //     console.info('case remove previewOutput done');
        // }
        // videoOutput = undefined;
        // previewOutput = undefined;
        console.info('case camera to commitConfig');
        await captureSession.commitConfig().then(() => {
            console.info('case camera commitConfig');
        }, mediaTestBase.failureCallback).catch(mediaTestBase.catchCallback);
        console.info('case camera commitConfig done');
        // console.info('case camera to stopCaptureSession');
        // await videoRecorderBase.releaseCaptureSession(captureSession);
    }
    ...
    * @tc.desc      : test avRecorder create-reset
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Reset_Promise_0100', 0, async function (done) {
        ...
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, RESET_PROMISE, RELEASE_PROMISE, END);
        nextStep(done);
    })
    ...
    * @tc.name      : 01. test avRecorder reset interface
    * @tc.desc      : test avRecorder reset-reset
    * @tc.size      : MediumTest
    * @tc.type      : Function
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Reset_Promise_0200', 0, async function (done) {
        let fileName = 'avRecorder_reset_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, RESET_PROMISE, RESET_PROMISE, RELEASE_PROMISE, END);
        nextStep(done);
    })
    ...
    */
    ...
    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_Reset_Promise_0700
    * @tc.name      : 01. test avRecorder reset interface
    ...
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Reset_Promise_0700', 0, async function (done) {
        let fileName = 'avRecorder_reset_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
    ...
    /* *
    * @tc.number    : Sub_Multimedia_Media_AVRecorder_Reset_Promise_0800
    * @tc.name      : 01. test avRecorder reset interface
    ...
    * @tc.level     : Level0
    */
    it('Sub_Multimedia_Media_AVRecorder_Reset_Promise_0800', 0, async function (done) {
        let fileName = 'avRecorder_reset_0'+ caseCount +'.mp4';
        await getRecorderFileFd(fileName, 'video');
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
    ...
    // /* *
    //     * @tc.number    : Sub_Multimedia_Media_AVRecorder_Reset_Callback_0100
    //     * @tc.name      : 01. test avRecorder reset interface
    //     * @tc.desc      : test avRecorder create-reset
    //     * @tc.size      : MediumTest
    //     * @tc.type      : Function
    //     * @tc.level     : Level0
    //     */
    // it('Sub_Multimedia_Media_AVRecorder_Reset_Callback_0100', 0, async function (done) {
    //     let fileName = 'avRecorder_reset_0'+ caseCount +'.mp4';
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_CALLBACK, RESET_CALLBACK, RELEASE_CALLBACK, END);
    //     nextStep(done);
    // })

    // /* *
    // * @tc.number    : Sub_Multimedia_Media_AVRecorder_Reset_Callback_0200
    // * @tc.name      : 01. test avRecorder reset interface
    // * @tc.desc      : test avRecorder reset-reset
    // * @tc.size      : MediumTest
    // * @tc.type      : Function
    // * @tc.level     : Level0
    // */
    // it('Sub_Multimedia_Media_AVRecorder_Reset_Callback_0200', 0, async function (done) {
    //     let fileName = 'avRecorder_reset_0'+ caseCount +'.mp4';
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_CALLBACK, RESET_CALLBACK, RESET_CALLBACK, RELEASE_CALLBACK, END);
    //     nextStep(done);
    // })
    ...
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
    //         STOPVIDEOOUTPUT, RELEASE_PROMISE, END);
    //     nextStep(done);
    // })
    ...
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
    //         PAUSE_PROMISE, STOPVIDEOOUTPUT, RELEASE_PROMISE, END);
    //     nextStep(done);
    // })
    ...
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
    //         PAUSE_PROMISE, RESUME_PROMISE, STOPVIDEOOUTPUT, RELEASE_PROMISE, END);
    //     nextStep(done);
    // })
    ...
    //     await getRecorderFileFd(fileName, 'video');
    //     mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START_PROMISE,
    //         PAUSE_PROMISE, RESUME_PROMISE, STOP_PROMISE, STOPVIDEOOUTPUT, RELEASE_PROMISE, END);
    //     nextStep(done);
    // })
