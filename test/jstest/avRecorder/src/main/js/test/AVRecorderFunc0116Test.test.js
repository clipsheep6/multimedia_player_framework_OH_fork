...
describe('AVRecorderFuncTest', function () {
    ...
    it('Sub_Multimedia_Media_AVRecorder_Prepare_01', 0, async function (done) {
        let fileName = 'AVRecorder_Prepare_01.mp4';
        console.info("case current fileName is: " + fileName);
    ...
    it('Sub_Multimedia_Media_AVRecorder_Prepare_02', 0, async function (done) {
        let fileName = 'AVRecorder_Prepare_02.mp4';
        console.info("case current fileName is: " + fileName);
        fdObject = await mediaTestBase.getFd(fileName, 'video');
        fdPath = "fd://" + fdObject.fdNumber.toString();
        console.info("case fdPath is: " + fdPath);
        ...
        avConfig = {
            ...
            url : 'fd://',
            rotation : 0,
            location : { latitude : "abc", longitude : "abc"}
        }
        avConfig.url = fdPath;
        await prepareError(done);
        await getInputSurface();
    ...
    // // 需调用getInputSurface
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_AudioOnly02', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_VideoSourceType02.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    //     console.info("case fdPath is: " + fdPath);
    ...
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Audio_Wrong01', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_Audio_Wrong01.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    //     console.info("case fdPath is: " + fdPath);
    ...
    // // 未报错！
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Audio_Wrong02', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_Audio_Wrong02.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    //     console.info("case fdPath is: " + fdPath);
    ...
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Audio_Wrong03', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_Audio_Wrong03.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    //     console.info("case fdPath is: " + fdPath);
    ...
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Audio_Wrong04', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_Audio_Wrong04.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    //     console.info("case fdPath is: " + fdPath);
    ...
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Video_Wrong01', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_Video_Wrong01.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    //     console.info("case fdPath is: " + fdPath);
    ...
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Video_Wrong02', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_Video_Wrong02.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    //     console.info("case fdPath is: " + fdPath);
    ...
    // // 不报错
    // it('Sub_Multimedia_Media_AVRecorder_Prepare_Video_Wrong03', 0, async function (done) {
    //     let fileName = 'AVRecorder_PrepareWrong_Video_Wrong03.mp4';
    //     console.info("case current fileName is: " + fileName);
    //     fdObject = await mediaTestBase.getFd(fileName, 'video');
    //     fdPath = "fd://" + fdObject.fdNumber.toString();
    //     console.info("case fdPath is: " + fdPath);
    ...
    //         videoBitrate : 20000000,
    //         videoCodec : media.CodecMimeType.VIDEO_AVC,
    //         videoFrameWidth : 640000,
    //         videoFrameHeight : 480000,
    //         videoFrameRate : 30
    //     }
    //     avConfig = {
    //         audioSourceType : media.AudioSourceType.AUDIO_SOURCE_TYPE_MIC,
