...
describe('VideoRecorderFuncPromiseTest', function () {
    ...
    it('SUB_MULTIMEDIA_MEDIA_AVRECORDER_FUNCTION_PROMISE_0100', 0, async function (done) {
        mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START, PAUSE, RESUME, STOP, RESET_PROMISE, RELEASE_PROMISE, END);
        nextStep(done);
    })

    // it('SUB_MULTIMEDIA_MEDIA_AVRECORDER_FUNCTION_PROMISE_0200', 0, async function (done) {
    //     mySteps = new Array(CREATE_PROMISE, PREPARE_PROMISE, GETSURFACE_PROMISE, STARTCAMERA, START, PAUSE, RESUME, STOP, RESET_PROMISE, RELEASE_PROMISE, END);
    //     nextStep(done);
    // })


    it('SUB_MULTIMEDIA_MEDIA_AVRECORDER_FUNCTION_CALLBACK_0100', 0, async function (done) {
        mySteps = new Array(CREATE_CALLBACK, PREPARE_CALLBACK, GETSURFACE_CALLBACK, STARTCAMERA, START, PAUSE, RESUME, STOP, RESET_CALLBACK, RELEASE_CALLBACK, END);
        nextStep(done);
    })

    // it('SUB_MULTIMEDIA_MEDIA_AVRECORDER_FUNCTION_TEST_0100', 0, async function (done) {
    //     mySteps = new Array(CREATE, PREPARE, GETSURFACE, STARTCAMERA, START, PAUSE, RESUME, STOP, RESET, RELEASE, END);
    //     nextStep(done);
    // })

    // it('SUB_MULTIMEDIA_MEDIA_AVRECORDER_FUNCTION_TEST_0200', 0, async function (done) {
    //     mySteps = new Array(CREATE, PREPARE, START, RESET, RELEASE, END);
    //     nextStep(done);
    // })

    // it('SUB_MULTIMEDIA_MEDIA_AVRECORDER_FUNCTION_TEST_0200', 0, async function (done) {
    //     mySteps = new Array(CREATE, PREPARE, GETSURFACE, STARTCAMERA, START, PAUSE, RESUME, PAUSE, RESET, RELEASE, END);
    //     nextStep(done);
    // })

    // it('SUB_MULTIMEDIA_MEDIA_AVRECORDER_FUNCTION_TEST_0300', 0, async function (done) {
    //     mySteps = new Array(CREATE, PREPARE, GETSURFACE, RESET, RELEASE, END);
    //     nextStep(done);
    // })

    // it('SUB_MULTIMEDIA_MEDIA_AVRECORDER_FUNCTION_TEST_0400', 0, async function (done) {
    //     mySteps = new Array(CREATE, PREPARE, GETSURFACE, RELEASE, END);
    //     nextStep(done);
    // })

    // it('SUB_MULTIMEDIA_MEDIA_AVRECORDER_FUNCTION_TEST_0500', 0, async function (done) {
    //     mySteps = new Array(CREATE, PREPARE, GETSURFACE, STARTCAMERA, START, RESET, RELEASE, END);
    //     nextStep(done);
    // })

    // it('SUB_MULTIMEDIA_MEDIA_AVRECORDER_FUNCTION_TEST_0600', 0, async function (done) {
    //     mySteps = new Array(CREATE, PREPARE, GETSURFACE, STARTCAMERA, START, RELEASE, END);
    //     nextStep(done);
    // })

    // it('SUB_MULTIMEDIA_MEDIA_AVRECORDER_FUNCTION_TEST_0700', 0, async function (done) {
    //     mySteps = new Array(CREATE, PREPARE, GETSURFACE, STARTCAMERA, START, PAUSE, RELEASE, END);
    //     nextStep(done);
    // })

    // it('SUB_MULTIMEDIA_MEDIA_AVRECORDER_FUNCTION_TEST_0800', 0, async function (done) {
    //     mySteps = new Array(CREATE, PREPARE, GETSURFACE, STARTCAMERA, START, STOP, RELEASE, END);
    //     nextStep(done);
    // })

    // it('SUB_MULTIMEDIA_MEDIA_AVRECORDER_FUNCTION_TEST_0900', 0, async function (done) {
    //     mySteps = new Array(CREATE, PREPARE, GETSURFACE, STARTCAMERA, START, PAUSE, RESET, RELEASE, END);
    //     nextStep(done);
    // })

    // it('SUB_MULTIMEDIA_MEDIA_AVRECORDER_FUNCTION_TEST_1000', 0, async function (done) {
    //     mySteps = new Array(CREATE, PREPARE, GETSURFACE, STARTCAMERA, START, PAUSE, RELEASE, END);
    //     nextStep(done);
    // })

    // it('SUB_MULTIMEDIA_MEDIA_AVRECORDER_FUNCTION_TEST_1100', 0, async function (done) {
    //     mySteps = new Array(CREATE, PREPARE, GETSURFACE, STARTCAMERA, START, PAUSE, RESUME, RESET, RELEASE, END);
    //     nextStep(done);
    // })

    // it('SUB_MULTIMEDIA_MEDIA_AVRECORDER_FUNCTION_TEST_1200', 0, async function (done) {
    //     mySteps = new Array(CREATE, PREPARE, GETSURFACE, STARTCAMERA, START, PAUSE, RESUME, RESET, RELEASE, END);
    //     nextStep(done);
    // })

    // it('SUB_MULTIMEDIA_MEDIA_AVRECORDER_FUNCTION_TEST_1300', 0, async function (done) {
    //     mySteps = new Array(CREATE, PREPARE, GETSURFACE, STARTCAMERA, START, STOP, RESET, RELEASE, END);
    //     nextStep(done);
    // })

    // it('SUB_MULTIMEDIA_MEDIA_AVRECORDER_FUNCTION_TEST_1400', 0, async function (done) {
    //     mySteps = new Array(CREATE, PREPARE, GETSURFACE, STARTCAMERA, START, STOP, STOPVIDEOOUTPUT, PREPARE, GETSURFACE, STARTCAMERA, START, RESUME, STOP, RELEASE, END);
    //     nextStep(done);
    // })
})
