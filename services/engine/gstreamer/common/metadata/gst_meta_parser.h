...
inline constexpr std::string_view FILE_MIMETYPE_VIDEO_MKV = "video/mkv";
inline constexpr std::string_view FILE_MIMETYPE_AUDIO_MKV = "audio/mkv";
inline constexpr std::string_view FILE_MIMETYPE_VIDEO_MPEGTS = "video/mpeg-ts";
inline constexpr std::string_view FILE_MIMETYPE_AUDIO_MPEGTS = "audio/mpeg-ts";
