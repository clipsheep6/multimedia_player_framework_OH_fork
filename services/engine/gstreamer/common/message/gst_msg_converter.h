...
public:
    ...
    virtual int32_t ConvertToInnerMsg(const GstMessage &gstMsg, InnerMessage &innerMsg) = 0;
};
...
public:
    ...
    int32_t ConvertToInnerMsg(const GstMessage &gstMsg, InnerMessage &innerMsg) override;
};
}
}
