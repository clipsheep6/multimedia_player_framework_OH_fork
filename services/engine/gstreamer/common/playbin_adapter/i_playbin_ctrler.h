...
public:
    ...
    virtual int32_t SelectVideoTrack(int32_t index) = 0;
    virtual int32_t SelectAudioTrack(int32_t index) = 0;
    virtual int32_t GetSelectVideoTrackIndex() = 0;
    virtual int32_t GetSelectAudioTrackIndex() = 0;
