...
enum CodecBinH264Profile {
    CODEC_BIN_H264_PROFILE_BASELINE = 0,
    CODEC_BIN_H264_PROFILE_CONSTRAINED_BASELINE,
    CODEC_BIN_H264_PROFILE_CONSTRAINED_HIGH,
    CODEC_BIN_H264_PROFILE_EXTENDED,
    CODEC_BIN_H264_PROFILE_HIGH,
    CODEC_BIN_H264_PROFILE_HIGH10,
    CODEC_BIN_H264_PROFILE_HIGH422,
    CODEC_BIN_H264_PROFILE_HIGH444,
    CODEC_BIN_H264_PROFILE_MAIN,
};

enum CodecBinH264BitMode {
    CODEC_BIN_H264_BIT_MODE_CBR = 0,
    CODEC_BIN_H264_BIT_MODE_VBR,
    CODEC_BIN_H264_BIT_MODE_CQ,
};
