...
static void gst_mux_bin_gst_mux_bin_free_list_element_string(GSList *list)
{
    GSList *iter = list;
...
static void gst_mux_bin_finalize(GObject *object)
{
    ...
    gst_mux_bin_gst_mux_bin_free_list_element_string(mux_bin->video_src_list);
    g_slist_free(mux_bin->video_src_list);
    mux_bin->video_src_list = nullptr;

    gst_mux_bin_gst_mux_bin_free_list_element_string(mux_bin->audio_src_list);
