...
public:
    ...
    ~HdiInit();
    int32_t GetHandle(CodecComponentType **component, std::string name, OMX_PTR appData, CodecCallbackType *callbacks);
    int32_t FreeHandle(CodecComponentType *component);
