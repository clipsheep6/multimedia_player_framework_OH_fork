...
{
    MEDIA_LOGE("enter MediaServer::GetSubSystemAbility");
    ...
    switch (subSystemId) {
        ...
        case MediaSystemAbility::MEDIA_FREEZER: {
            return MediaServerManager::GetInstance().CreateStubObject(MediaServerManager::FREEZER);
        }
        default: {
