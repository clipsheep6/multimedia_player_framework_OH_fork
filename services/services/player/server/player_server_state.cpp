...
int32_t PlayerServer::PreparedState::ResumeForSeek()
{
    return server_.HandleResumeForSeek();
}
...
{
    server_.PausedHandleEos();
}

int32_t PlayerServer::PausedState::ResumeForSeek()
{
    return server_.HandleResumeForSeek();
}
