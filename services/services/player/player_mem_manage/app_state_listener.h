...
namespace OHOS {
namespace Media {
class AppStateListener : public AppStateSubscriber {
public:
    AppStateListener();
    ~AppStateListener();

    virtual void OnConnected() override;
    virtual void OnDisconnecter() override;
    virtual void OnAppStateChanged(int32_t pid, int32_t uid, int32_t state) override;
    virtual void ForceReclaim(int32_t pid, int32_t uid);
    virtual void OnTrim(AppExecFwk::MemoryLevel level) override;
