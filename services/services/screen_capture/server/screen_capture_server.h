...
public:
    void OnConnected();
    void OnDisconnected();
    void OnResponse(int32_t notificationId, OHOS::sptr<OHOS::Notification::NotificationButtonOption> buttonOption);
    void OnDied();
...
public:
    ...
    static int32_t StartInnerScreenCapture(int32_t sessionId, std::string choice);
    ScreenCaptureServer();
    ~ScreenCaptureServer();
