...
void ScreenCaptureListenerProxy::OnAudioBufferAvailable(bool isReady, AudioCapSourceType type)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option(MessageOption::TF_ASYNC);
...
void ScreenCaptureListenerCallback::OnAudioBufferAvailable(bool isReady, AudioCapSourceType type)
{
    if (listener_ != nullptr) {
