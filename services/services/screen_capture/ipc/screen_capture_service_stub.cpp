...
int32_t ScreenCaptureServiceStub::Init()
{
    ...
    screenCaptureStubFuncs_[SETMICENABLE] = &ScreenCaptureServiceStub::SetMicrophoneEnable;
...
int32_t ScreenCaptureServiceStub::InitAudioCap(AudioCapInfo audioInfo)
{
...
int32_t ScreenCaptureServiceStub::InitVideoCap(VideoCapInfo videoInfo)
{
    CHECK_AND_RETURN_RET_LOG(screenCaptureServer_ != nullptr, false,
        "screen capture server is nullptr");
...
int32_t ScreenCaptureServiceStub::SetMicrophoneEnable(bool isMicrophone)
{
    CHECK_AND_RETURN_RET_LOG(screenCaptureServer_ != nullptr, false,
        "screen capture server is nullptr");
    return screenCaptureServer_->SetMicrophoneEnable(isMicrophone);
}

int32_t ScreenCaptureServiceStub::AcquireAudioBuffer(std::shared_ptr<AudioBuffer> &audioBuffer, AudioCapSourceType type)
{
    CHECK_AND_RETURN_RET_LOG(screenCaptureServer_ != nullptr, false,
        "screen capture server is nullptr");
...
int32_t ScreenCaptureServiceStub::ReleaseAudioBuffer(AudioCapSourceType type)
{
    CHECK_AND_RETURN_RET_LOG(screenCaptureServer_ != nullptr, false,
        "screen capture server is nullptr");
...
int32_t ScreenCaptureServiceStub::SetMicrophoneEnable(MessageParcel &data, MessageParcel &reply)
{
    CHECK_AND_RETURN_RET_LOG(screenCaptureServer_ != nullptr, MSERR_INVALID_STATE,
        "screen capture server is nullptr");
    (void)data;
    bool setMicEnable = data.ReadBool();
    int32_t ret = SetMicrophoneEnable(setMicEnable);
...
int32_t ScreenCaptureServiceStub::InitAudioCap(MessageParcel &data, MessageParcel &reply)
{
    CHECK_AND_RETURN_RET_LOG(screenCaptureServer_ != nullptr, MSERR_INVALID_STATE,
        "screen capture server is nullptr");
    (void)data;
    AudioCapInfo audioInfo;
    audioInfo.audioSampleRate = data.ReadInt32();
    audioInfo.audioChannels = data.ReadInt32();
    audioInfo.audioSource = static_cast<AudioCapSourceType>(data.ReadInt32());
...
int32_t ScreenCaptureServiceStub::AcquireAudioBuffer(MessageParcel &data, MessageParcel &reply)
{
    ...
    AudioCapSourceType type = static_cast<AudioCapSourceType>(data.ReadInt32());
