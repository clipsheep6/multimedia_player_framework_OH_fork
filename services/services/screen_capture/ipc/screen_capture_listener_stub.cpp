    ...
    MessageOption &option)
{
   ...
   /*     case ScreenCaptureListenerMsg::ON_SCREEN_CAPTURE_BUFFER_GO_BACK: {
            //未实现
            //int errorType = data.ReadInt32();
            //int errorCode = data.ReadInt32();
            OnScreenCaptureBufferGoBack();
            return MSERR_OK;
        }*/
...
void ScreenCaptureListenerStub::OnAudioBufferAvailable(bool isReady, AudioCapSourceType type)
{
    if (callback_ != nullptr) {
