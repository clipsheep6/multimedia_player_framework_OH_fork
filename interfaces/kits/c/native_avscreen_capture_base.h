...
typedef struct OH_VideoCapInfo {
    /* Display id of avscreeencapture */
    uint64_t displayId;
...
/**
 * @brief Audio & Video avscreeencapture config info
 * @syscap SystemCapability.Multimedia.Media.AVScreenCapture
 *
 * @since 10
 * @version 1.0
...
typedef struct OH_AVScreenCaptureConfig {
    /**
     * Screen capture mode
     * 0 - Fullscreen screen capture mode;
     * 1 - The internal screen capture mode of the application.
     **/
    int captureMode;
