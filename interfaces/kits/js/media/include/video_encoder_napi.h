...
enum VideoEncoderCreator : int32_t {
    VIDEO_ENCODER_CREATOR_BY_NAME = 0,
    VIDEO_ENCODER_CREATOR_BY_CODEC = 1,
};
...
private:
    ...
    static napi_value CreateVideoEncoderByCodec(napi_env env, napi_callback_info info);
    ...
    static void CommonCallbackRoutine(napi_env env, VideoEncoderAsyncContext* &asyncContext,
