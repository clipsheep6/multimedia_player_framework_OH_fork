...
enum AudioEncoderCreator : int32_t {
    AUDIO_ENCODER_CREATOR_BY_NAME = 0,
    AUDIO_ENCODER_CREATOR_BY_CODEC = 1,
};
...
private:
    ...
    static napi_value CreateAudioEncoderByCodec(napi_env env, napi_callback_info info);
    ...
    static void CommonCallbackRoutine(napi_env env, AudioEncoderAsyncContext* &asyncContext,
