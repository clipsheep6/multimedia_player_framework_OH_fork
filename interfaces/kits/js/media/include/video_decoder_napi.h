...
#ifndef VIDEO_DECODER_NAPI_H_
#define VIDEO_DECODER_NAPI_H_
...
private:
    ...
    std::shared_ptr<VideoDecoder> nativeDecoder_ = nullptr;
    std::shared_ptr<VideoDecoderCallback> callbackNapi_ = nullptr;
};
}  // namespace Media
}  // namespace OHOS
#endif // VIDEO_DECODER_NAPI_H_
