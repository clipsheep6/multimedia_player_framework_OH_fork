...
function createVideoDecoderByCodec(codec: string): VideoDecoder;
function createVideoEncoderByName(name: string): VideoEncoder;
function createVideoEncoderByCodec(codec: string): VideoEncoder;
function createAudioDecoderByName(name: string): AudioDecoder;
function createAudioDecoderByCodec(codec: string): AudioDecoder;
function createAudioEncoderByName(name: string): AudioEncoder;
function createAudioEncoderByCodec(codec: string): AudioEncoder;
