...
public:
    static std::shared_ptr<AudioDecoder> CreateByCodecName(const std::string &name);
    static std::shared_ptr<AudioDecoder> CreateByDecoderName(const std::string &name);
private:
