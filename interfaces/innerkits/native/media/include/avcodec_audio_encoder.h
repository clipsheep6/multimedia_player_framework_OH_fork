...
public:
    static std::shared_ptr<AudioEncoder> CreateByCodecName(const std::string &name);
    static std::shared_ptr<AudioEncoder> CreateByEncoderName(const std::string &name);
private:
