...
public:
    static std::shared_ptr<VideoEncoder> CreateByCodecName(const std::string &name);
    static std::shared_ptr<VideoEncoder> CreateByEncoderName(const std::string &name);
private:
