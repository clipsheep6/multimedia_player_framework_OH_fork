...
public:
    static std::shared_ptr<VideoDecoder> CreateByCodecName(const std::string &name);
    static std::shared_ptr<VideoDecoder> CreateByDecoderName(const std::string &name);
private:
