...
public:
    ...
    /**
     * @brief Sets a video encoder for transcodering.
     *
    ...
    /**
     * @brief Sets an audio encoder for transcodering.
     *
     ...
     * @version 1.0
     */
    virtual int32_t SetInputFile(int32_t fd) = 0;
    ...
    * You can call this function to resume transcodering after {@link Pause} is called.
    ...
    /**
     * @brief Releases transcodering resources. After this function called, none of interfaces of {@link Recorder}
     * can be used.
     *
     * @return Returns {@link MSERR_OK} if the transcodering is stopped; returns an error code otherwise.
     * @since 1.0
