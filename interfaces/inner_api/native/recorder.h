...
constexpr std::string_view CFT_MPEG_4 = "mp4";
constexpr std::string_view CFT_MPEG_4A = "m4a";
/**
...
public:
    ...
    * You can call this function to resume recording after {@link Pause} is called.
     ...
     *
     * @param sourceId Indicates the camera source ID.
     * The value <b>-1</b> indicates an invalid ID and the setting fails.
