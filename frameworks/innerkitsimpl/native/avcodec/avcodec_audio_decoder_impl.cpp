...
namespace OHOS {
namespace Media {
std::shared_ptr<AudioDecoder> AudioDecoderFactory::CreateByCodecName(const std::string &name)
{
...
int32_t AudioDecoderImpl::QueueInputBuffer(uint32_t index, AVCodecBufferInfo info,
