...
public:
    explicit AudioEncoderCallbackNapi(napi_env env, std::shared_ptr<AudioEncoder> audioEncoderImpl);
...
private:
    ...
    void OnJsStateCallBack(AudioEncoderJsCallback *jsCb) const;
    void OnJsInputCallBack(AudioEncoderJsCallback *jsCb) const;
    void OnJsOutputCallBack(AudioEncoderJsCallback *jsCb) const;
    std::shared_ptr<AutoRef> StateCallbackSelect(const std::string &callbackName) const;
    napi_env env_ = nullptr;
    std::shared_ptr<AudioEncoder> audioEncoderImpl_ = nullptr;
    std::mutex mutex_;
