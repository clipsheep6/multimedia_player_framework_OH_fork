...
{
    MEDIA_LOGD("OnInputBufferAvailable() is called");
}

void AudioEncoderCallbackNapi::OnOutputBufferAvailable(uint32_t index, AVCodecBufferInfo info,
                                                       AVCodecBufferType type, AVCodecBufferFlag flag)
{
    MEDIA_LOGD("OnOutputBufferAvailable() is called");
}
