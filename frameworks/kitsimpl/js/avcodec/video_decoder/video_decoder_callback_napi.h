...
public:
    explicit VideoDecoderCallbackNapi(napi_env env, std::shared_ptr<VideoDecoder> videoDecoderImpl);
...
private:
    ...
    void OnJsStateCallBack(VideoDecoderJsCallback *jsCb) const;
    void OnJsInputCallBack(VideoDecoderJsCallback *jsCb) const;
    void OnJsOutputCallBack(VideoDecoderJsCallback *jsCb) const;
