...
public:
    explicit AudioDecoderCallbackNapi(napi_env env, std::shared_ptr<AudioDecoder> audioDecoderImpl);
...
private:
    ...
    void OnJsInputCallBack(AudioDecoderJsCallback *jsCb) const;
    void OnJsOutputCallBack(AudioDecoderJsCallback *jsCb) const;
