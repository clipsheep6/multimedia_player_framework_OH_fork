...
namespace OHOS {
namespace Media {
VideoEncoderCallbackNapi::VideoEncoderCallbackNapi(napi_env env)
    : env_(env)
{
...
void VideoEncoderCallbackNapi::OnOutputBufferAvailable(uint32_t index, AVCodecBufferInfo info,
