...
napi_value VideoPlayerNapi::SetFdSrc(napi_env env, napi_callback_info info)
{
    ...
    (void)CommonNapi::GetFdArgument(env, args[0], jsPlayer->rawFd_);
...
napi_value VideoPlayerNapi::GetFdSrc(napi_env env, napi_callback_info info)
{
    ...
    CHECK_AND_RETURN_RET(CommonNapi::AddNumberProp(env, jsResult, "fd", jsPlayer->rawFd_.fd) == true, nullptr);
    CHECK_AND_RETURN_RET(CommonNapi::AddNumberProp(env, jsResult, "offset", jsPlayer->rawFd_.offset) == true, nullptr);
    CHECK_AND_RETURN_RET(CommonNapi::AddNumberProp(env, jsResult, "length", jsPlayer->rawFd_.length) == true, nullptr);
